...
from multi_mujoco.mujoco_env.episode import *
from multi_mujoco.mujoco_env.tasks.rearrangement.rearrangement_task import COMRearrangementTask

# Milestone 1:
# Floating ball (translation only)
gym.register(
    id="Milestone-1",
    entry_point="spear_env.spear_env:MujocoEnv",
    kwargs=dict(
