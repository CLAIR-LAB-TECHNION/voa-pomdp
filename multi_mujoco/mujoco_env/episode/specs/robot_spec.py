...
class RobotSpec(InitStateAddonSpec):
    ...
    def __post_init__(self):
        ...
        object.__setattr__(self, 'base_pos', np.asarray(self.base_pos, dtype=np.float64))
        object.__setattr__(self, 'base_orient', np.asarray(self.base_orient, dtype=np.float64))
