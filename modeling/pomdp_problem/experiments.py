...
def get_positions_and_init_belief():
    mus = [[-0.5555811001989546, -0.8685714370415379], [-0.5510296397412436, -0.5921838671142652], [-0.8559652664168667, -0.8528636466344859], [-0.784730232877579, -0.5888542174800786]]
    sigmas = [[0.14044278905235758, 0.11851284931192309], [0.03893375750787616, 0.0802298602164658], [0.13037169026799353, 0.03926828321910571], [0.11914382647817032, 0.08134558114274028]]

    belief = BeliefModel(4, workspace_x_lims_default, workspace_y_lims_default, mus, sigmas)

    block_positions = [[-0.6225174767780174, -0.9063979509309235], [-0.5818126962048723, -0.684841526937952], [-0.6989217892322716, -0.8132851505436323], [-0.8356209326158366, -0.5579876134076684]]
