...
def get_positions_and_init_belief():
    mus = [[-0.732127891955538, -0.7393143055852641], [-0.7193323184754087, -0.8918125757768423], [-0.6291860620511132, -0.5700026578625002], [-0.8711418382622178, -0.8625889633045167]]
    sigmas = [[0.040085807866483636, 0.1105221305975788], [0.03315372206789103, 0.09565434691953964], [0.07960827738201944, 0.12214610877871533], [0.13723838044938816, 0.03322187419489277]]

    belief = BeliefModel(4, workspace_x_lims_default, workspace_y_lims_default, mus, sigmas)

    block_positions = [[-0.6699847770660389, -0.9489467918173264], [-0.8598398774218375, -0.7388775656987532], [-0.5536092016562228, -0.6098603918183879], [-0.6851262938668077, -0.8448798087738675]]
